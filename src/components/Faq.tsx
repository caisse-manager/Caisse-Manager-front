...
export default function FAQ() {
  ...
  return (
    ...
    <div className="p-4 container mx-auto min-h-screen ">
      <h1 className="text-4xl lg:text-7xl font-light text-black dark:text-white mb-6 leading-tight ">
        Frequently Asked <br /> Questions
      </h1>
      <div className="flex justify-between flex-wrap">
      <ul className="max-w-6xl pt-4 mb-6 ">
        {faqs.map((faq, index) => (
          <li
            key={index}
            className="border-b border-gray-300 p-4 cursor-pointer dark:border-gray-700"
            onClick={() => toggleFAQ(index)}
          >
            <div className="flex justify-between ">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{faq.question}</h3>
              <ArrowUpRight
      ...
      <section className="max-w-4xl mr-6 ">
